...
describe('interestCounts', () => {
  ...
  it('다중 interest 매칭 — 둘 다 count', () => {
    saveAnswers([
      { id: '1', text: '리더십과 AI를 둘 다 다룬 답변', schemaVersion: 1, questionId: 'q1', authorId: 'self', createdAt: '2026-05-08T00:00:00Z', pinned: false },
    ] satisfies Answer[]);
  ...
  it('사용자 정의 분야 (interestKeywords 빈 배열) → count 0', () => {
    saveAnswers([
      { id: '1', text: '리더십', schemaVersion: 1, questionId: 'q1', authorId: 'self', createdAt: '2026-05-08T00:00:00Z', pinned: false },
    ] satisfies Answer[]);
  ...
  describe('v3.22 T3 — INTERESTS.find guard (P2-3)', () => {
    it('catalog 외 id가 답변 텍스트에 우연 매칭되어도 count 0', () => {
      ...
      saveAnswers([
        { id: '1', text: 'leadership_v2 spec 검토', schemaVersion: 1, questionId: 'q1', authorId: 'self', createdAt: '2026-05-08T00:00:00Z', pinned: false },
      ] satisfies Answer[]);
    ...
    it('catalog 외 id 스크랩 — title/summary 매칭되어도 count 0', () => {
      saveBriefings([
        { id: 'b1', date: '2026-05-08', url: 'https://x.com/1', title: 'custom_topic 동향', summary: 'custom_topic update', scrapped: true, read: false, memo: '', pinned: false },
      ] satisfies Briefing[]);
